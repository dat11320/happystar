...
// function checkusser($username, $password){
...
// function user_update($username, $password, $email, $diachi, $dienthoai, $dienthoai, $id ){
//     $sql = "UPDATE user SET username=?(username, password, email, diachi, dienthoai, role, id) VALUES (?, ?, ?, ?, ?, ?, ?)";
//     pdo_execute($sql, $username, $password, $email, $diachi, $dienthoai, $role, $id);
